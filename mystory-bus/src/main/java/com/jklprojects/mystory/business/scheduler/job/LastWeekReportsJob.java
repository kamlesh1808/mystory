...
@Stateless
@LocalBean
public class LastWeekReportsJob extends AbstractScheduleJob {
	private static final XLogger logger = XLoggerFactory.getXLogger(LastWeekReportsJob.class);

	@EJB
	private ReportDistributionService reportDistributionService;

	public LastWeekReportsJob() {
		super();
	}
